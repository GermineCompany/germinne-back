...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('artigoBlog', [
      {
        idCategoria: 1,
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.bulkDelete('artigoBlog', null, {});
  }
};
